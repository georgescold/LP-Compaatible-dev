...
const rawQuestions = [
  ...
  // === A1 - Trust (plus) ===
  { id: 'ce2fbbf8-7a97-4199-bda5-117e4ecdf3b6', text: 'Je fais confiance aux gens tant qu\'ils ne m\'ont pas trahi', keyed: 'plus', domain: 'A', facet: 1 },
  ...
  // === A5 - Modesty (minus) ===
  { id: '71029381-3908-4c68-91e1-e41fb45542a2', text: 'Je me considère comme meilleur(e) que la plupart des gens', keyed: 'minus', domain: 'A', facet: 5 },
  // === C5 - Self-discipline (plus) ===
  { id: 'f6076eea-56ae-4b46-97f1-5f94a7676c96', text: 'Je planifie mes tâches à l\'avance avant de m\'y mettre', keyed: 'plus', domain: 'C', facet: 5 },
  // === N6 - Vulnerability (plus) ===
  { id: '2f519935-92e8-48ad-9746-4a0f8b38466a', text: 'Je perds mes moyens face à une situation imprévue', keyed: 'plus', domain: 'N', facet: 6 },
  ...
  { id: 'bd9eec0a-b68b-472c-8803-7db29c308cdb', text: 'Je fonce souvent sans peser le pour et le contre', keyed: 'minus', domain: 'C', facet: 6 },
  // === N1 - Anxiety (plus) ===
  ...
  // === N3 - Depression (plus) ===
  { id: 'f0a14e16-d726-47e9-a2c1-647fd3d7d52e', text: 'J\'ai souvent une mauvaise estime de moi-même', keyed: 'plus', domain: 'N', facet: 3 },
  // === E3 - Assertiveness (plus) ===
  { id: '0b38e3d3-c15c-454c-b034-f4eb7ae1580a', text: 'J\'aime organiser et diriger les activités de groupe', keyed: 'plus', domain: 'E', facet: 3 },
  // === O3 - Emotionality (plus) ===
  { id: '5631b856-ff34-4f76-a0cd-edc7104c3bfa', text: 'Je capte facilement les émotions des personnes autour de moi', keyed: 'plus', domain: 'O', facet: 3 },
  // === A3 - Altruism (plus) ===
  { id: 'ada867af-4db1-4e3d-a604-2b695c1806e5', text: 'Je me soucie sincèrement du bien-être de mon entourage', keyed: 'plus', domain: 'A', facet: 3 },
  // === C3 - Dutifulness (plus) ===
  ...
  // === E4 - Activity level (plus) ===
  { id: 'd07b6c67-0d02-4948-a997-bb84ac234cd8', text: 'J\'ai du mal à rester assis(e) sans rien faire', keyed: 'plus', domain: 'E', facet: 4 },
  // === O4 - Adventurousness (minus) ===
  ...
  // === E5 - Excitement-seeking (plus) ===
  { id: 'f1675af6-88bf-4376-a946-0281e762b39c', text: 'Je suis attiré(e) par les voyages, l\'aventure et la découverte', keyed: 'plus', domain: 'E', facet: 5 },
  // === O5 - Intellect (minus) ===
  ...
  // === E6 - Cheerfulness (plus) ===
  { id: '961376e0-16a1-4c14-b059-789e63d11b63', text: 'Je trouve du plaisir dans les petites choses du quotidien', keyed: 'plus', domain: 'E', facet: 6 },
  // === O6 - Liberalism (plus) ===
  ...
  // === C1 - Self-efficacy (plus) ===
  { id: '02ee1930-36a7-4caa-b10c-c93efb682a44', text: 'Je sais bien m\'organiser pour venir à bout de mes tâches', keyed: 'plus', domain: 'C', facet: 1 },
  // === N2 - Anger (plus) ===
  { id: 'da8e6ed1-2296-4c58-8fdb-66f2f591989b', text: 'Je perds patience quand les choses n\'avancent pas assez vite', keyed: 'plus', domain: 'N', facet: 2 },
  ...
  // === A2 - Morality (minus) ===
  { id: '982e83c2-d34e-48da-9c71-78494ab05c85', text: 'Il m\'arrive d\'utiliser les gens pour servir mes propres intérêts', keyed: 'minus', domain: 'A', facet: 2 },
  // === C2 - Orderliness (minus) ===
  ...
  { id: '7317848c-3e1b-422f-bb16-02efc504f677', text: 'Les moments gênants en public ne me perturbent pas', keyed: 'minus', domain: 'N', facet: 4 },
  ...
  // === O4 - Adventurousness (minus) ===
  { id: 'a7f43928-8982-4ed5-8656-7a80346fe979', text: 'Je m\'en tiens aux méthodes connues plutôt que d\'essayer de nouvelles approches', keyed: 'minus', domain: 'O', facet: 4 },
  // === A4 - Cooperation (minus) ===
  { id: '17910a55-a64a-4ed0-8b46-293e2fa2fe03', text: 'Quand ça ne va pas, je m\'en prends parfois aux personnes autour de moi', keyed: 'minus', domain: 'A', facet: 4 },
  ...
  // === O5 - Intellect (minus) ===
  { id: 'b86de003-c3c4-4cc8-9385-5ac8a0142c34', text: 'Les débats intellectuels ou théoriques me lassent rapidement', keyed: 'minus', domain: 'O', facet: 5 },
  // === A5 - Modesty (minus) ===
  ...
  // === O6 - Liberalism (minus) ===
  { id: '580b08d1-3c94-46e9-9d07-d6d80c698127', text: 'Je pense qu\'on devrait punir plus sévèrement ceux qui enfreignent la loi', keyed: 'minus', domain: 'O', facet: 6 },
  // === A6 - Sympathy (minus) ===
